...
## Features
1) [User registration with confirmation mail to user to set user as an active user.](#register-new-user-to-the-application-and-send-confirmation-email-to-the-user)
2) [Login with management of session using access and refresh token.](#login-to-the-application-and-in-successful-login-returns-user-details-with-access-and-refresh-token)
3) [Logout user.](#logout-from-the-application)
4) [Forgot password with reset password mail to user to reset their password.](#send-reset-password-link-to-email)
5) [Change password.](#change-user-password)
